...
public final class CastUtil {
     ...
     * @return 转换后的Object
     */
    public static Object convert(Class<?> type, String value,HttpServletRequest request) {
        if (isPrimitive(type)) {
            if (ValidateUtil.isEmpty(value)) {
                return primitiveNull(type,request);
            }
     ...
     * @return 对应的空值
     */
    public static Object primitiveNull(Class<?> type, HttpServletRequest request) {
